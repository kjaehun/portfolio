...
// this function calls malloc to reserve space to manage with our memory allocator
// this will be the only call to malloc
void Initialize_Memory_Allocator(int size) {
    ...
    unsigned long start = (unsigned long)__start_of_heap; // cast to do arithmetic
